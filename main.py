...
from src.handlers.users.qaydvaraqa import qv_router
...
async def main():
    ...
    # 'Mandat saytdagi o'rni', 'Balingizga mos yo'nalish' va 'Qaydvaraqa
    # bo'yicha tekshirish' — user_router'dan OLDIN: ular o'z FSM holatlarida
    # ID/PDF/ball kutadi, umumiy handler ushlab qolmasin
    dp.include_router(orin_router)
    dp.include_router(yonalish_router)
    dp.include_router(qv_router)
